...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="pages">
            <xsl:for-each select="tei:TEI/tei:text/tei:body/tei:div[@xml:id='kapelski.2']/tei:div[@type='crit']//tei:pb">
        ...
        <xsl:variable name="sections">
            <xsl:for-each select="tei:TEI/tei:text/tei:body/tei:div[@xml:id='kapelski.2']/tei:div[@type='crit']//tei:milestone">
                ...
                <div class="medium-4 columns">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="kapelski-para.html?type=page&amp;mode=facs-dipl-crit&amp;page={if ($page) then $page else $firstPB}&amp;lb={if ($lb) then $lb else '1'}">
                            ...
                            <a href="kapelski-para.html?type=section&amp;mode=dipl-crit&amp;section={$firstMilestone}&amp;lb={if ($lb) then $lb else '1'}">
                ...
                <div class="medium-4 columns">
                    <xsl:if test="$type='page'">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="kapelski-para.html?type=page&amp;mode=facs-dipl&amp;page={if ($page) then $page else $firstPB}&amp;lb={if ($lb) then $lb else '1'}">
                                    <xsl:if test="$mode = 'facs-dipl'">
                                        <xsl:attribute name="class">active</xsl:attribute>
                                    </xsl:if>
                                    <xsl:text>Faksimile / Diplomatični prepis</xsl:text>
                                </a>
                                <a href="kapelski-para.html?type=page&amp;mode=facs-crit&amp;page={if ($page) then $page else $firstPB}&amp;lb={if ($lb) then $lb else '1'}">
                                    <xsl:if test="$mode = 'facs-crit'">
                                        <xsl:attribute name="class">active</xsl:attribute>
                                    </xsl:if>
                                    <xsl:text>Faksimile / Kritični prepis</xsl:text>
                                </a>
                                <a href="kapelski-para.html?type=page&amp;mode=dipl-crit&amp;page={if ($page) then $page else $firstPB}&amp;lb={if ($lb) then $lb else '1'}">
                    ...
                    <xsl:if test="$type='section'">
                        <a class="button" href="kapelski-para.html?type=section&amp;mode=dipl-crit&amp;section={if ($section) then $section else $firstMilestone}&amp;lb={if ($lb) then $lb else '1'}">
                            <xsl:text>Diplomatični / Kritični prepis</xsl:text>
                        </a>
                    </xsl:if>
                </div>
                        ...
                        <dir class="row">
                            ...
                            <div class="small-6 columns">
                                <div class="secondary button-group">
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;{if ($page) then ('page='||$page) else ('section='||$section)}&amp;lb=1">
                                        <xsl:if test="$lb='1'">
                                            <xsl:attribute name="style">background: #8e130b;</xsl:attribute>
                                        </xsl:if>
                                        <xsl:text>Da</xsl:text>
                                    </a>
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;{if ($page) then ('page='||$page) else ('section='||$section)}&amp;lb=0">
                                        <xsl:if test="$lb='0'">
                                            <xsl:attribute name="style">background: #8e130b;</xsl:attribute>
                                        </xsl:if>
            ...
            <xsl:if test="$type and $mode and ($page or $section)">
                ...
                <xsl:if test="$type='page'">
                    ...
                    <div class="row">
                        <div class="small-3 columns">
                            <p>
                                <xsl:if test="$previousPage != ''">
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;page={$previousPage}&amp;lb={$lb}">
                        ...
                        <div class="small-6 columns">
                            <form action="kapelski-para.html" autocomplete="off">
                        ...
                        <div class="small-3 columns text-right">
                            <p>
                                <xsl:if test="$nextPage != ''">
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;page={$nextPage}&amp;lb={$lb}">
                    ...
                    <div class="row show-for-medium">
                        <div class="medium-{if ($mode='facs-dipl-crit') then '4' else '6'} columns text-center">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <a class="button" href="kapelski.1.html#{$page-start-dipl}">Celotno besedilo</a>
                                </xsl:otherwise>
                            </xsl:choose>
                        </div>
                        <div class="medium-{if ($mode='facs-dipl-crit') then '4' else '6'} columns text-center">
                            ...
                            <xsl:if test="tokenize($mode,'-')[2] = 'crit'">
                                <a class="button" href="kapelski.2.html#{$page-start-crit}">Celotno besedilo</a>
                            </xsl:if>
                        </div>
                        <xsl:if test="$mode='facs-dipl-crit'">
                ...
                <xsl:if test="$type='section' and $mode != 'toc'">
                    <!-- Pred glavno vsebino na vrhu najprej prikažemo vrstico za premikanje naprej in nazaj po vsebinskih sklopih izbora (spodaj jih nisem dal):
                    ...
                    <div class="row">
                        <div class="small-3 columns">
                            <p>
                                <xsl:if test="$previousSection != ''">
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;section={$previousSection}&amp;lb={$lb}">
                        ...
                        <div class="small-3 columns text-center">
                            ...
                            <a class="button" href="kapelski-para.html?type={$type}&amp;mode=toc&amp;section={$section}&amp;lb={$lb}">Kazalo</a>
                        </div>
                        <div class="small-3 columns text-right">
                            <p>
                                <xsl:if test="$nextSection != ''">
                                    <a class="button" href="kapelski-para.html?type={$type}&amp;mode={$mode}&amp;section={$nextSection}&amp;lb={$lb}">
                    ...
                    <xsl:if test="$mode='dipl-crit'">
                        ...
                        <div class="row show-for-medium">
                            <div class="medium-6 columns text-center">
                                <a class="button" href="kapelski.1.html#{$section-start-dipl}">Celotno besedilo</a>
                            </div>
                            <div class="medium-6 columns text-center">
                                <a class="button" href="kapelski.2.html#{$section-start-crit}">Celotno besedilo</a>
                            </div>
                        </div>
                    </xsl:if>
                </xsl:if>
                ...
                <xsl:if test="$type='section' and $mode='toc'">
                    ...
                    <div class="row" id="treeview-container">
                        ...
                        <ul>
                            <li>
                                <a href="kapelski-para.html?type={$type}&amp;mode=dipl-crit&amp;section={$milestones/milestone[1]/@n}&amp;lb={$lb}">
                                ...
                                <ul>
                                    <xsl:for-each-group select="$milestones/milestone[string-length(@n2) gt 0]" group-by="@n1">
                                        <li>
                                            <a href="kapelski-para.html?type={$type}&amp;mode=dipl-crit&amp;section={@n}&amp;lb={$lb}">
    ...
    <xsl:template name="page-start">
        ...
        <xsl:variable name="fascID">
            <xsl:text>#kpl-</xsl:text>
            <xsl:choose>
        ...
        <xsl:value-of select="//tei:pb[@facs=$fascID][matches(@xml:id,$content-type)]/@xml:id"/>
    </xsl:template>
            ...
            <xsl:variable name="fascID">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="matches($nextPage,'[0-9]{2}')">
                        <xsl:value-of select="concat('0',$nextPage)"/>
                    </xsl:when>
                    <xsl:when test="matches($nextPage,'[0-9]')">
                        <xsl:value-of select="concat('00',$nextPage)"/>
                    </xsl:when>
                </xsl:choose>
            </xsl:variable>
            <xsl:value-of select="//tei:pb[@facs=$fascID][matches(@xml:id,$content-type)]/@xml:id"/>
    ...
    <xsl:template name="section-start">
        ...
        <xsl:param name="content-type"/>
        <xsl:value-of select="//tei:milestone[@n=$section][matches(@xml:id,$content-type)]/@xml:id"/>
    </xsl:template>
    ...
    <xsl:template name="section-end">
        ...
        <xsl:param name="content-type"/>
        <xsl:if test="$nextSection != ''">
            <xsl:value-of select="//tei:milestone[@n=$nextSection][matches(@xml:id,$content-type)]/@xml:id"/>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template name="process-content">
        ...
        <xsl:variable name="content">
            ...
            <xsl:apply-templates select="tei:TEI/tei:text/tei:body/tei:div/tei:div[@type=$content-type]/*">
                <xsl:with-param name="type" select="$type"/>
                <xsl:with-param name="mode" select="$mode"/>
    ...
    <xsl:template match="tei:note">
        <!-- Ne vem, zakaj ne odpre explain div??? zato trenutno note ne procesiram -->
    ...
    <xsl:template match="tei:trailer">
        ...
        <xsl:if test="$type='page'">
            <xsl:if test="if ($content-end='') then (preceding::tei:pb[1][@xml:id=$content-start]) else (preceding::tei:pb[1][@xml:id=$content-start]  and following::tei:pb[1][@xml:id=$content-end])">
                <p>
                    <xsl:if test="$content-type = 'crit' and @xml:lang[matches(.,'-')]">
    ...
    <!-- izjema je orig, ki ga moram spodaj zaradi deljenja besed procesirati posebej -->
    <xsl:template match="tei:abbr | tei:expan | tei:sic | tei:corr | tei:reg">
        <xsl:param name="type"/>
        <xsl:param name="mode"/>
        <xsl:param name="content-start"/>
        <xsl:param name="content-end"/>
    ...
    <!-- posebej procesiram zaradi notranjega deljenja besed (samo en takšen primer) -->
        ...
        <xsl:if test="$type='page'">
            <xsl:choose>
                <xsl:when test="if ($content-end='') then (preceding::tei:pb[1][@xml:id=$content-start]) else (preceding::tei:pb[1][@xml:id=$content-start]  and following::tei:pb[1][@xml:id=$content-end])">
                    <xsl:choose>
                        <xsl:when test="@lemma">
                            <span class="term" data-explain="{@xml:id}">
                                <xsl:apply-templates>
                                    <xsl:with-param name="type" select="$type"/>
                                    <xsl:with-param name="mode" select="$mode"/>
                                    <xsl:with-param name="content-start" select="$content-start"/>
    ...
    <xsl:template name="content-word">
        ...
        <div  id="{$wordId}" class="explain" style="display: none;">
            <ul>
                <xsl:if test="@lemma">
            ...
            <xsl:when test="parent::tei:div">
                <p>
                    <xsl:attribute name="class">
                        <xsl:choose>
                            <xsl:when test="$content-type = 'crit' and @xml:lang[matches(.,'-')]">stage translate</xsl:when>
                            <xsl:otherwise>stage</xsl:otherwise>
                        </xsl:choose>
                    </xsl:attribute>
                    <xsl:apply-templates>
                        <xsl:with-param name="type" select="$type"/>
